...
<div style="overflow-x:hidden; width: 100%;">
    <header class="thk">
        <div class="container">
            <div class="row">
                <div class="col-8 col-lg-6 lft"><img src="img/logo.png" alt="Logo"></div>
                    ...
                    <nav class="navbar">
                        ...
                        <div class="navbar-collapse1">
                            ...
                            <ul class="navbar-nav ml-auto mt-2 mt-lg-0">
                                <li class="nav-item active"> <a class="nav-link" href="index.html#hire">Hire How?</a> </li>
                                <li class="nav-item"> <a class="nav-link" href="index.html#pay">Pay What?</a> </li>
                                <li class="nav-item"> <a class="nav-link" href="index.html#why">Why Us?</a> </li>
                                <li class="nav-item"> <a class="nav-link" href="index.html#who">Hire Who?</a> </li>
                                <li class="nav-item"> <a class="nav-link" href="index.html#clients">Clients</a> </li>
                                <li class="nav-item"> <a class="nav-link" href="index.html#connect">Connect</a> </li>
                            </ul>
                        </div>
                    </nav>
                </div>
...
<div class="container">
    ...
    <div class="col-lg-12 text-center">
        <h2>Thank <span class="grn">You</span></h2>
        <p>Our Recruitment Specialist will get back to you soon.</p>
...
<div class="container">
    ...
    <div class="col-lg-12">
        ...
        <div class="mnu">
        <ul>
        <li> <a href="index.html">Hire How?</a> </li>
        <li> <a href="index.html">Pay What?</a> </li>
        <li> <a href="index.html">Why Us?</a> </li>
        <li> <a href="index.html">Hire Who?</a> </li>
        <li> <a href="index.html">Clients</a> </li>
        <li> <a href="index.html">Connect</a> </li>
        </ul>
        </div>
        <div class="copy">Copyright © 2020 JobVersify.com. All rights reserved. Service Use and Privacy Guidelines</div>
        </div>
    </div>
    </div>    
</footer>    
