...
<html lang="en">
    ...
    <![endif]-->
  <meta name="google-site-verification" content="XUZfRZXca779JdznNawsQN-O_CcltmzV8mhP29ikVYo" />
        ...
        <nav class="megamenu navbar navbar-default">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="" style="font-size: 40px; color: #a8cf45;line-height: 40px;display: inline-block;"><img src="images/logo.png" style="width: 60px;float: left;margin-right: 20px;" alt="JobVersify"><h1 style="float: right;font-size: 40px;color: #a8cf45;">JobVersify</h1></a>
                </div>
            ...
            <div class="row">
				...
				<div class="col-md-12 col-sm-12">
                    <div class="big-tagline clearfix">
                        <h2>Something <span style="color: #a8cf45; font-size: 70px;">BIG</span><br> is coming soon </h2>
                        <p class="lead">Email: <a href="mailto:info@jobversify.com" style="color: white;">info@jobversify.com</a></p>
        ...
        <div class="container">
            <div class="footer-distributed">
                <div class="footer-left">
                    <p class="footer-company-name">&copy; 2019 <a href="#">JobVersify</a>. All Rights Reserved. Design and Market By <a href="https://www.digiversal.in/">Digiversal</a></p>
                </div>
